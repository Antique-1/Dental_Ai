...
# 설정값
# ─────────────────────────────────────────
DATA_YAML   = r"C:/Users/kbg00/data/processed/data.yaml"
OUTPUT_DIR  = r"runs/train"
IMG_SIZE    = 640
EPOCHS      = 150          # 데이터 100장(증강 포함 ~400장)으로 적어 충분히 학습
BATCH_SIZE  = 32          # RTX 4080(16GB) 기준 여유. OOM 시 16으로 낮추세요
...
def train_model(model_name: str, model_weight: str,
    ...
    results = model.train(
        ...
        project    = output_dir,
        name       = model_name,
        patience   = 30,          # Early Stopping (데이터 적어 여유있게)
        optimizer  = "AdamW",
        lr0        = 0.001,
        lrf        = 0.01,
        momentum   = 0.937,
